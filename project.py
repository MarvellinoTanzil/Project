...
btn_mod = tk.Button(root, text="%", command=lambda: add_to_calculation("%"), width=5, font=("Lora", 14), fg = "#fff", bg = "#2a2d36")
btn_mod.grid(row=6, column=2)
btn_dod = tk.Button(root, text=".", command=lambda: add_to_calculation("."), width=5, font=("Lora", 14), fg = "#fff", bg = "#2a2d36")
btn_dod.grid(row=6, column=3)
